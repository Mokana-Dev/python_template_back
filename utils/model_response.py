            ...
            for relationship in mapper.relationships:
                ...
                if related_obj is not None:
                    if relationship.uselist:
                        if isinstance(related_obj, collections.InstrumentedList):
                            data[relationship.key] = [cls.to_dict(item) for item in related_obj]
                        else:
                            data[relationship.key] = [cls.to_dict(related_obj)]
                    else:
                        data[relationship.key] = cls.to_dict(related_obj)
